    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12 px-3">
          <h2 class="display-4">I am Atia Ayesha Prema</h2>
...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      <br><br>
      <h3 class="card-title text-danger text-center"><b>Atia Ayesha Prema</b></h3>
    ...
    <div class="card-footer">
      <small class="text-success"><b>Mobile - 01908728750</b></small>
    </div>
  </div>
  <div class="card">
    <img src="images/3.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h3 class="card-title text-danger text-center"><b>Nur Mohammad</b></h3>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h3 class="card-title text-danger text-center"><b>Meheraz Istiaque</b></h3>
    ...
    <footer>
        <p class="bg-dark text-white text-center py-3">@AyeshaIT Dhaka</p>
    </footer>
